...
result_ground_truth = test_llm_ground_truth(giskard_model, giskard_dataset)
result_similarity = test_llm_ground_truth_similarity(giskard_model, giskard_dataset)
